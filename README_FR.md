...
- « Actualités des réinitialisations Codex » ne télécharge que le flux de statut public. Il n’envoie aucun compte Codex, jeton ou contenu de session locale.
...
- **Actualités des réinitialisations Codex** : les données viennent de [https://www.codexrunway.com/api/status.json](https://www.codexrunway.com/api/status.json). Non officiel et indicatif seulement ; peut être retardé ou temporairement indisponible.
