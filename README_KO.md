...
CodexRunway는 Codex와 Grok 할당량을 확인하는 네이티브 macOS 메뉴 막대 앱입니다. Codex의 오늘 리셋 여부, reset credits, API 환산 비용, 로컬 세션과 공급자별 다중 계정 관리를 제공합니다.
...
- 설정에서 「오늘 리셋되었나요?」 섹션을 켜고 자체 새로고침 간격을 구성합니다(기본값: 켜짐, 5분).
